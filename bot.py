...
from sqlalchemy import Column, String, Integer, DateTime, Boolean, Text, JSON, BigInteger, Float
import pytz
...
for directory in [DOWNLOAD_DIR, THUMBNAIL_DIR, LOGS_DIR, DATABASE_DIR, TEMP_DIR, COOKIES_DIR, CACHE_DIR, BACKUP_DIR]:
...
ERRORS_DB = DATABASE_DIR / "errors.json"
...
VIDEO_QUALITIES = {
    '144': {
        ...
        'description_ar': 'جودة منخفضة جداً',
        'emoji': '📱',
        'height': 144,
        'width': 256,
        'bitrate': '100k',
        ...
        'suitable_for_ar': ['الجوال', 'الإنترنت البطيء'],
        'icon': '📱'
    },
    '240': {
        'name': '240p',
        ...
        'suitable_for_ar': ['الجوال', 'البيانات المحدودة'],
        'icon': '📱'
    },
    '360': {
        'name': '360p',
        ...
        'suitable_for_ar': ['الجوال', 'التابلت'],
        'icon': '📱'
    },
    '480': {
        'name': '480p',
        ...
        'suitable_for_ar': ['التابلت', 'الشاشة الصغيرة'],
        'icon': '📺'
    },
    '720': {
        'name': '720p HD',
        ...
        'suitable_for_ar': ['تلفزيون HD', 'الكمبيوتر'],
        'icon': '💻'
    },
    '1080': {
        'name': '1080p Full HD',
        ...
        'description_ar': 'جودة عالية جداً',
        'emoji': '🎥',
        'height': 1080,
        'width': 1920,
        'bitrate': '5000k',
        ...
        'suitable_for_ar': ['تلفزيون Full HD', 'الشاشة'],
        'icon': '🖥️'
    },
    '1440': {
        'name': '2K Quad HD',
        ...
        'suitable_for_ar': ['شاشة 2K', 'الألعاب'],
        'icon': '🖥️'
    },
    '2160': {
        'name': '4K Ultra HD',
        'name_ar': '٤ كيه',
        'description': 'Ultra High Quality',
        'description_ar': 'جودة فائقة جداً',
        'emoji': '🎥',
        'height': 2160,
        'width': 3840,
        'bitrate': '20000k',
        ...
        'suitable_for_ar': ['تلفزيون 4K', 'المسرح المنزلي'],
        'icon': '📺'
    },
    '4320': {
        'name': '8K Ultra HD',
        ...
        'suitable_for_ar': ['تلفزيون 8K', 'احترافي'],
        'icon': '🎬'
    },
    'best': {
        'name': 'Best Quality',
        ...
        'description_ar': 'أفضل جودة تلقائياً',
        'emoji': '🏆',
        'height': 9999,
        'width': 9999,
        'bitrate': 'best',
        ...
        'suitable_for_ar': ['أفضل جودة متاحة'],
        'icon': '⭐'
    }
}
...
DOWNLOAD_FORMATS = {
    ...
    'webm': {
        ...
        'compatibility_ar': 'المتصفحات الحديثة',
        'icon': '🌍'
    },
    'mkv': {
        'name': 'MKV',
        ...
        'compatibility_ar': 'VLC والمشغلات',
        'icon': '🗃️'
    },
    'avi': {
        'name': 'AVI',
        ...
        'compatibility_ar': 'ويندوز والأجهزة القديمة',
        'icon': '📼'
    },
    'mov': {
        'name': 'MOV',
    ...
    'wav': {
        'name': 'WAV',
        'name_ar': 'دبليو إيه في',
        'description': 'Uncompressed Audio',
        'description_ar': 'صوت غير مضغوط',
        'emoji': '🎼',
        'extension': 'wav',
        'mime_type': 'audio/wav',
        'audio_codec': 'pcm',
        ...
        'compatibility_ar': 'احترافي',
        'icon': '💿'
    },
    'flac': {
        'name': 'FLAC',
        'name_ar': 'إف إل إيه سي',
        'description': 'Lossless Audio',
        'description_ar': 'صوت بدون فقد',
        'emoji': '💿',
        'extension': 'flac',
...
VIDEO_CATEGORIES = {
    ...
    'gaming': {
        ...
        'keywords': ['game', 'playthrough', 'walkthrough']
    },
    'news': {
        'name': '📰 News',
        'name_ar': 'أخبار',
        ...
        'keywords': ['breaking', 'headlines', 'update']
    },
    'sports': {
        'name': '⚽ Sports',
        'name_ar': 'رياضة',
        ...
        'keywords': ['football', 'basketball', 'highlights']
    },
    'education': {
        'name': '📚 Education',
        'name_ar': 'تعليم',
    ...
    'technology': {
        ...
        'keywords': ['gadget', 'review', 'unboxing']
    },
    'entertainment': {
        'name': '🎭 Entertainment',
        'name_ar': 'ترفيه',
    ...
    'animation': {
        ...
        'keywords': ['cartoon', 'anime', 'animated']
    },
    'documentary': {
        'name': '📽️ Documentary',
        'name_ar': 'وثائقيات',
        ...
        'keywords': ['documentary', 'real', 'true story']
    },
    'cooking': {
        'name': '🍳 Cooking',
        'name_ar': 'طبخ',
    ...
    'travel': {
        ...
        'keywords': ['vlog', 'travel', 'adventure']
    },
    'fashion': {
        'name': '👗 Fashion',
        'name_ar': 'موضة',
        ...
        'keywords': ['style', 'clothing', 'designer']
    },
    'beauty': {
        'name': '💄 Beauty',
        'name_ar': 'تجميل',
        ...
        'keywords': ['makeup', 'beauty', 'skincare']
    },
    'fitness': {
        'name': '💪 Fitness',
        'name_ar': 'لياقة',
    ...
    'science': {
        ...
        'keywords': ['experiment', 'science', 'discovery']
    },
    'history': {
        'name': '📜 History',
        'name_ar': 'تاريخ',
...
class DatabaseManager:
    ...
    def load_all(self):
        ...
        for file_path in [USERS_DB, STATS_DB, DOWNLOADS_DB, BANNED_DB, CHANNELS_DB, CONFIG_DB, CACHE_DB, ERRORS_DB]:
            if file_path.exists():
                try:
...
class StatsManager:
    ...
    async def get_detailed_stats(self) -> Dict:
        ...
        # Get system stats
        stats['system_stats']['cpu_usage'] = psutil.cpu_percent()
        stats['system_stats']['memory_usage'] = psutil.virtual_memory().percent
        stats['system_stats']['disk_usage'] = psutil.disk_usage('/').percent
    ...
    async def log_error(self, error_type: str, error_msg: str, user_id: int = None):
        ...
        # Store in database
        errors = await self.db.get(ERRORS_DB, 'errors', [])
        ...
        await self.db.set(ERRORS_DB, 'errors', errors)
...
👇 *Select quality:*
        ...
        for i, (quality_id, quality_info) in enumerate(VIDEO_QUALITIES.items(), 1):
            button = InlineKeyboardButton(
                f"{quality_info['emoji']} {quality_info['name_ar']}",
...
🎬 *Quality:* {VIDEO_QUALITIES[quality]['emoji']} {VIDEO_QUALITIES[quality]['name_ar']}
⏱ *Duration:* {self.format_time(video_info.get('duration', 0))}
...
👇 *Select format:*
        ...
        for i, (format_id, format_info) in enumerate(DOWNLOAD_FORMATS.items(), 1):
            button = InlineKeyboardButton(
                f"{format_info['emoji']} {format_info['name_ar']}",
    ...
    async def start_download(self, update: Update, context: ContextTypes.DEFAULT_TYPE, 
        ...
        progress_msg = await query.edit_message_text(
            ...
            f"⚡ Quality: {VIDEO_QUALITIES[quality]['emoji']} {VIDEO_QUALITIES[quality]['name_ar']}\n"
            f"📁 Format: {DOWNLOAD_FORMATS[format]['emoji']} {DOWNLOAD_FORMATS[format]['name_ar']}\n\n"
            f"⏳ Please wait...",
            parse_mode=ParseMode.MARKDOWN
        )
            ...
            if d['status'] == 'downloading':
                ...
                if total > 0:
                    ...
                    if int(percentage) % 5 == 0:
                        ...
                        asyncio.create_task(progress_msg.edit_text(text, parse_mode=ParseMode.MARKDOWN))
...
⚙️ *Settings:*
• Quality: {VIDEO_QUALITIES.get(user_data.get('settings', {}).get('default_quality', 'best'), {}).get('name_ar', 'Best')}
• Format: {DOWNLOAD_FORMATS.get(user_data.get('settings', {}).get('default_format', 'mp4'), {}).get('name_ar', 'MP4')}
...
🎬 *Default Quality:* {VIDEO_QUALITIES.get(settings.get('default_quality', 'best'), {}).get('name_ar', 'Best')}
📁 *Default Format:* {DOWNLOAD_FORMATS.get(settings.get('default_format', 'mp4'), {}).get('name_ar', 'MP4')}
...
❤️ *Thank you for using the bot!*
    ...
    async def handle_callback(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        # Settings
            ...
            await query.answer(f"✅ Default quality set to {VIDEO_QUALITIES[quality]['name_ar']}")
            await self.show_settings(update, context)
            ...
            await self.user_manager.update_user(user_id, {'settings': settings})
            await query.answer(f"✅ Default format set to {DOWNLOAD_FORMATS[format_type]['name_ar']}")
            await self.show_settings(update, context)
